...
export const stringifyRouteQueryString = (_object: IGenericObject) => {
...
export const createRedirectRoute = ({
  ...
  url: string;
  routeSearchParams?: IGenericObject;
  routeHashParams?: IGenericObject;
  params?: string[];
  values?: string[];
}): string => {
...
export const validateField = (
  ...
  } else if (validationRule === VALIDATION_RULE.url && !isURL(_val)) {
    errorsObj[fieldKey] = MESSAGES.GENERAL.INVALID_REQUEST;
  } else if (
...
export const extractInnerData = <T>(
  _object: IGenericObject | unknown,
